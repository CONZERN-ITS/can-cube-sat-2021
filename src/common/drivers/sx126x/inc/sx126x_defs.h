...
{
	SX126x_ERROR_UNEXPECTED_VALUE		= 0x01,
	SX126X_ERROR_INVALID_VALUE			= 0x02,
	SX126X_ERROR_BAD_STATE				= 0x03,
	SX126X_ERROR_BOARD					= 0x04,
	SX126X_ERROR_NOT_IMPLEMENTED		= 0x05,
	SX126X_ERROR_CHIP_FAILURE			= 0x06,
	SX126X_ERROR_TIMED_OUT				= 0x07
} sx126x_error_t;
