...
#define I2C_LINK_DMA_STREAM_TX (LL_DMA_STREAM_7)
#define I2C_LINK_DMA_CHANNEL_TX (LL_DMA_CHANNEL_7)
#define I2C_LINK_DMA_STREAM_RX (LL_DMA_STREAM_3)
#define I2C_LINK_DMA_CHANNEL_RX (LL_DMA_CHANNEL_7)
