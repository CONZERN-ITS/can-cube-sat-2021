...
#define MICS6814_CO_RB_1	(150*1000)
#define MICS6814_CO_RB_2	(100*1000)
...
// Значение резистора в верхнем плече делителя сенсора
#define MICS6814_NO2_RB_1	(680*1000)
#define MICS6814_NO2_RB_2	(330*1000)
...
// Значение резистора в верхнем плече делителя сенсора
#define MICS6814_NH3_RB_1	(150*1000)
#define MICS6814_NH3_RB_2	(100*1000)
