 ...
 * x1 = 1000 y1 = 0.01,
 * x2 = 10   x2 = 0.5 */
#define MICS6814_CO_COEFFS_A	(-0.849485002168009)
#define MICS6814_CO_COEFFS_EXP_B	(1.73057722080471)

// Значение R0 (сопротивление сенсора в калибровочной атмосфере)
#define MICS6814_CO_R0	(26.54 * 1000)
// Значение резистора в верхнем плече делителя сенсора
#define MICS6814_CO_RB_1	(125*1000)
#define MICS6814_CO_RB_2	(93*1000)
#define MICS6814_CO_RB_3	(1*1000)
...
// Значение R0 (сопротивление сенсора в калибровочной атмосфере)
#define MICS6814_NO2_R0	(11.02*1000)
// Значение резистора в верхнем плече делителя сенсора
#define MICS6814_NO2_RB_1	(580*1000)
#define MICS6814_NO2_RB_2	(280*1000)
#define MICS6814_NO2_RB_3	(1*1000)
...
// Значение R0 (сопротивление сенсора в калибровочной атмосфере)
#define MICS6814_NH3_R0	(23.61*1000)
// Значение резистора в верхнем плече делителя сенсора
#define MICS6814_NH3_RB_1	(93*1000)
#define MICS6814_NH3_RB_2	(93*1000)
#define MICS6814_NH3_RB_3	(1*1000)
